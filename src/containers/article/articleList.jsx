  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => (
          <span>
            <Link to={"/article/edit?id=" + record._id + ""}>
              <Button>
                <Icon type="edit" />
              </Button>
            </Link>
            <Popconfirm
              title="确定要删除吗?"
              onConfirm={() => showDeleteConfirm(record._id, "article", this)}
            >
              <Button>
                <Icon type="delete" />
              </Button>
      ...
      },
      {
        ...
        render: (text, record, index) => (
          <Popconfirm
            title="确定要删除吗?"
            onConfirm={() =>
              showDeleteConfirm(record._id, "comment", this, index)
            }
          >
            <Button>
              <Icon type="delete" />
...
const mapDispatchToProps = (dispatch, ownProps) => {
  let actions = bindActionCreators(
    { operateArticle, getArticleList, deleteComment },
    dispatch
  );
